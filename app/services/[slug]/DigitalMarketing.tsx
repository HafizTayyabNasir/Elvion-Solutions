    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#0a0a0a] overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-[linear-gradient(rgba(74,144,226,0.12)_1px,transparent_1px),linear-gradient(90deg,rgba(74,144,226,0.12)_1px,transparent_1px)] bg-[size:50px_50px]" style={{ animation: 'pulse 6s ease-in-out infinite' }}></div>
